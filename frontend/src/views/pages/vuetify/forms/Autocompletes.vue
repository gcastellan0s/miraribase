        ...
        <KTCodePreview v-bind:title="'Slots'">
          <template v-slot:preview>
            <v-card color="blue-grey darken-1" dark :loading="isUpdating">
              ...
              <v-img height="200" src="assets/media/blog/blog4.jpg">
                <v-row>
...
const srcs = {
  1: "assets/media/users/300_1.jpg",
  2: "assets/media/users/300_2.jpg",
  3: "assets/media/users/300_3.jpg",
  4: "assets/media/users/300_4.jpg",
  5: "assets/media/users/300_5.jpg"
};
...
>
  ...
  <v-img
    height="200"
    src="assets/media/blog/blog4.jpg"
  >
    <v-row>
      <v-col
        class="text-right"
