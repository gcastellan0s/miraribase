                ...
                <v-row justify="space-between">
                  <v-col cols="auto">
                    <v-img
                      height="200"
                      width="200"
                      src="assets/media/products/product19.jpg"
                    ></v-img>
                  </v-col>
          ...
          <template v-slot:preview>
            <v-card class="mx-auto" max-width="400">
              <v-img
                class="white--text align-end"
                height="200px"
                src="assets/media/products/product18.jpg"
              >
  ...
  data: () => ({
    cards: [
      ...
      },
      {
        ...
        src: "assets/media/products/product24.jpg",
        flex: 6
      },
      {
        title: "Best airlines",
...
>
  ...
  data: () => ({
    items: [
      {
        color: '#1F7087',
        src: 'assets/media/products/product16.jpg',
        title: 'Supermodel',
        artist: 'Foster the People',
      },
      {
        color: '#952175',
        src: 'assets/media/products/product17.jpg',
        title: 'Halcyon Days',
